...
> **What it means:** The network is wide **OPEN**. Your packet successfully traveled from Dev and reached the Production container. It was "refused" only because **no any service-web-server** is running on port 80 (only simple app with log...), proving there is zero network isolation!
